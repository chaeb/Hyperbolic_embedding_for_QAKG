...
class MultiheadAttPoolLayer(nn.Module):
    ...
    def forward(self, q, k, curvature, mask=None):
        """
        q: tensor of shape (b, d_q_original) , !! : text encoder output -> 이미 유클리디안에 있음
        k: tensor of shape (b, l, d_k_original), !! : gnn output -> log map으로 보낸 다음 multiheadattention을 취하자.
        mask: tensor of shape (b, l) (optional, default None)
        ...
        ks = self.hyper.logmap0(ks, curvature)
